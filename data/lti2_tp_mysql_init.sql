...
CREATE TABLE `lti2_tp_registrations` (
  ...
  `tool_proxy_response` text CHARACTER SET utf8mb4,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
VALUES
	...
	(6,'wirelog_filename','~/wirelog.html','2014-04-22 00:00:00','2014-04-22 00:00:00'),
	(7,'tp_deployment_url_home','http://rails.kinexis.com:5000','2013-01-13 20:12:10','2013-01-13 20:12:10');
